...
public enum ErrorState {
	...
	EXISTS_EMAIL(HttpStatus.BAD_GATEWAY, "Email may already be in use."),
	REFRESH_TOKEN_EXPIRED(HttpStatus.BAD_GATEWAY, "Refresh token was expired. Please make a new signin request."),
